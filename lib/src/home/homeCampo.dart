...
class campoHome  extends StatefulWidget {
  @override
  State<campoHome > createState() => _campoHomeState();
}

class _campoHomeState  extends State<campoHome> {
  String error = "hola";
  ...
  List<String> etapas = ['Etapa I', 'Etapa II', 'Etapa III', 'Etapa IV', 'Etapa V', 'Etapa VI', 'Etapa VII','Etapa VIII'];
  String? etapasSelected = 'Etapa I';

  List<String> campos = ['Campo 1', 'Campo 2', 'Campo 3', 'Campo 4', 'Campo 5', 'Campo 6', 'Campo 7', 'Campo 8'];
  String? camposSelected = 'Campo 1';
  ...
  String? escuelaSelected = 'Cosecha';
      ...
      if (nombres_text.toString() == "" ||
        ...
        if (resultado.toString() == "ok") {
          if (tipo_concepto == "Capacitación") {
            mFormBottomSheetCapacitacion(context,  tipo_concepto.toString() + " en campo", usuarioLogeado_dni
                , dni_trabajador, txtNombreTrabajador_Controller.text, dni_jefe
                , txtNombreJefe_Controller.text, escuela, unidad, canal,etapa,campo);
          } else {
            mFormBottomSheet(context,  tipo_concepto.toString() + " en campo", usuarioLogeado_dni
                , dni_trabajador, txtNombreTrabajador_Controller.text, dni_jefe
                , txtNombreJefe_Controller.text, escuela, unidad, canal,tipo_concepto,etapa,campo);
          }
        } else {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                              ...
                                              MaterialButton(
                                                ...
                                                onPressed: () async {
                                                  BuscarTrabajador(2, txtDniTrabajador_Controller.text, txtDniJefe_Controller.text,
                                                      ...
                                                      canalSelected.toString(), tipoSelected.toString(),etapasSelected.toString(),camposSelected.toString());
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SelectSync(dni_sesion, dni_trabajador, nombres_trabajador, dni_jefe,
                nombres_jefe, escuela, unidad, canal, tipo_concepto,etapa,campo),
          ],
        ),
      );
    },
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SelectCapacitacion(dni_sesion, dni_trabajador, nombres_trabajador,
                dni_jefe, nombres_jefe, escuela, unidad, canal,etapa,campo),
          ],
        ),
      );
    },
...
class _SelectSyncState extends State<SelectSync> {
  ...
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  final GlobalKey<FormState> _formKey__ = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    ...
    String vr_etapa = widget.etapa;
    String vr_campo = widget.campo;
