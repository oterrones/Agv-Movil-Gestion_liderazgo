...
class HomeAccionPacking extends StatefulWidget {
  @override
  State<HomeAccionPacking> createState() => _HomeAccionPackingState();
}

class _HomeAccionPackingState extends State<HomeAccionPacking> {
  // All journals
  ...
  void _refreshJournals() async {
    ...
    final data = await DBProvider.db.getAllResultadosPackingAccion();
    setState(() {
      _journals = data;
      _isLoading = false;
    });
  ...
  Future<void> _sincronizacion_data() async {
    ...
    final data = await DBProvider.db.enviarDataLiderazgoPackingAWS_Accion();
    setState(() {
                                  ...
                                  children: <InlineSpan>[
                                    WidgetSpan(
                                        child: Container(
                                          ...
                                          child: Row(
                                              children:[ Text(_journals[index]['fecha']+'  '+_journals[index]['hora']),],)
                                        )
                                    ),
                                    WidgetSpan(
                                        child: Container(
